...
class PerdinJenisPekerjaan extends Model
{
    protected $fillable = ['nama'];
    protected $table = 'perdin__jenis_pekerjaan';
    ...
    public static function getJenisPekerjaan($request)
    {

        try {

            $get = DB::table('perdin__jenis_pekerjaan');
...
class self extends PerdinJenisPekerjaan
{
