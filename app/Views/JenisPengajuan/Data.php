...
<!-- TOOLBAR TABLE -->
<?= view_cell('App\Libraries\Widget\Toolbar::toolbarTable', ['except' => ['detail', 'ubah', 'buat_akun']]); ?>
<!-- TOOLBAR TABLE -->
...
<script src="<?= base_url('js/JenisPengajuan/DataJenisPengajuan.js') ?>"></script>
<script src="<?= base_url('js/JenisPengajuan/HapusJenisPengajuan.js') ?>"></script>
<script src="<?= base_url('js/JenisPengajuan/UbahJenisPengajuan.js') ?>"></script>
