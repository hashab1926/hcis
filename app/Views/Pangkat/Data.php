    ...
    <div class="col">
        ...
        <div class="card" style="border-top-left-radius:0;">
            <div class="card-body padding-x-1">
                ...
                <table id="datatable_jabatan" class="table strip-table" style="width:100%">
...
<script src="<?= base_url('js/Pangkat/DataPangkat.js') ?>"></script>
<script src="<?= base_url('js/Pangkat/HapusPangkat.js') ?>"></script>
