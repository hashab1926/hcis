                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 offset-lg-2">
                            ...
                            <div class="row">
                                <div class="col ">
                                    <img src="<?= base_url('img/undraw-connection.svg') ?>" width=300 class='d-block mx-auto d-xs-none d-sm-none d-md-none d-lg-block d-xl-block d-none'>

                                </div>
                            </div>
                            <form id="pangkat-store" method="POST">
                                <div class="row">
                                    <div class="col-12 padding-bottom-3 margin-top-4">
                                        <div class="form-group padding-x-5">
                                            <label for="first-name-column">Nama Pangkat</label>
                                            <input type="text" id="nama_pangkat" class="form-control custom-input-height" placeholder="Pangkat" name="nama_pangkat">
                                        </div>
                                    </div>
...
<script src="<?= base_url('js/Pangkat/TambahPangkat.js') ?>"></script>
<?= $this->endSection() ?>