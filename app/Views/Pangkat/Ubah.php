                                        ...
                                        <div class='d-flex flex-column '>
                                            ...
                                            <div class='row'>
                                                <div class='col-12 margin-top-2'>
                                                    <label class='fweight-700'>Nama Pangkat</label>
                                                    <div class="text-muted"><input type='text' name="nama_pangkat[<?= $list->id ?>]" class='form-control custom-input-height' value="<?= $list->nama_pangkat ?>" /></div>
                                                </div>
                                            </div>
...
<script src="<?= base_url('js/Pangkat/UbahPangkat.js') ?>"></script>
