                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 offset-lg-2">
                            ...
                            <form id="jenisfasilitas-store" method="POST">
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6 col-xs-12 col-md-12 padding-bottom-3 margin-top-4">
                                        <div class="form-group padding-x-5">
                                            <label for="first-name-column">Kode Fasilitas</label>
                                            <input type="text" id="first-name-column" class="form-control custom-input-height" placeholder="Kode" name="kode_fasilitas">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-6 col-xs-12 col-md-12 padding-bottom-3 margin-top-4">
                                        <div class="form-group padding-x-5">
                                            <label for="first-name-column">Nama Jenis </label>
                                            <input type="text" id="first-name-column" class="form-control custom-input-height" placeholder="Nama Fasilitas" name="jenis_fasilitas">
                                        </div>
                                    </div>
...
<script src="<?= base_url('js/Lainnya/JenisFasilitas/TambahJenisFasilitas.js') ?>"></script>
<?= $this->endSection() ?>