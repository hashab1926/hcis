...
<div class="row">
    <div class="col">
        <?= $this->include('Lainnya/WbsElement/Menu') ?>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 offset-lg-2">
                            ...
                            <form id="wbselement-store" method="POST">
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6 col-xs-12 col-md-12 padding-bottom-3 margin-top-4">
                                        <div class="form-group padding-x-5">
                                            <label for="first-name-column">Kode Wbs Element</label>
                                            <input type="text" id="first-name-column" class="form-control custom-input-height" placeholder="Kode" name="kode_wbs_element">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-6 col-xs-12 col-md-12 padding-bottom-3 margin-top-4">
                                        <div class="form-group padding-x-5">
                                            <label for="first-name-column">Nama </label>
                                            <input type="text" id="first-name-column" class="form-control custom-input-height" placeholder="Nama" name="nama_wbs_element">
                                        </div>
                                    </div>
...
<script src="<?= base_url('js/Lainnya/WbsElement/TambahWbsElement.js') ?>"></script>
<?= $this->endSection() ?>