    ...
    <div class="col">
        ...
        <div class="" style="border-top-left-radius:0;">
            <div class="card-body padding-x-1 pt-0">
                <form id="wbselement-updatestore">
                    <div class="row">
                        <?php
                                        ...
                                        <div class='d-flex flex-column '>
                                            ...
                                            <div class='row'>
                                                <div class='col-lg-6 col-xl-6 col-xs-12 col-md-12 margin-top-2'>
                                                    <label class='fweight-700'>Kode Wbs Element</label>
                                                    <div class="text-muted"><input type='text' name="kode_wbs_element[<?= $list->id ?>]" class='form-control custom-input-height' value="<?= $list->kode_wbs_element ?>" /></div>
                                                </div>

                                                <div class='col-lg-6 col-xl-6 col-xs-12 col-md-12 margin-top-2'>
                                                    <label class='fweight-700'>Nama</label>
                                                    <div class="text-muted"><input type='text' name="nama_wbs_element[<?= $list->id ?>]" class='form-control custom-input-height' value="<?= $list->nama_wbs_element ?>" /></div>
                                                </div>
...
<script src="<?= base_url('js/Lainnya/WbsElement/UbahWbsElement.js') ?>"></script>
