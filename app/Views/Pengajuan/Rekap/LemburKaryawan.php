...
<div class="row margin-top-3">
    <div class="col">
        <div class="d-flex flex-column  text-center">
            <div class='fweight-500 text-lg-1 text-dark'>Rekapitulasi Lembur Karyawan</div>
            <p class='text-muted text-md-2'>Cari karyawan yang telah mengajukan Lembur karyawan disini</p>
        </div>
...
<div id='tipe-pengajuan' data-type='lemburkaryawan'></div>
